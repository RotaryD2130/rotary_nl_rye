...
List<Inbounds> inboundList = [
  // Bence Német-Deák
  Inbounds(
    name: 'Bence Német-Deák',
    bio:
        'My name is Német-Deák Bence and I’m reprsenting Romania. I’m 17 and I live in a flat apartment in the town, named Odorheiu Secuisesc with family, my mother, my father, my sister and our chubby guinea pig, Gömbi. During the exchange programme, I will go to Rotary District 1610 and be hosted by Rotary Club Roosendaal-Donkenland.\n\nOne of my favourite hobbies is playing chess. I’d started it at the age of 7 and actively played it until I was 12. I had participated in several competitions in Romania. I have managed to earn a lot of trophies in those competitions. Now I only play in local competitions. Apart from playing and following chess I like playing video games, watching films, ice skating when it’s winter, hanging out with my friends.\n\nWith this golden opportunity my dream has come true. I hope I will make a new friendships and learn new things.\n\nI simply can’t wait to finally be in The Netherlands. \n\nMy chess.com user id is nemetdeakbence if someone wants to play a game.',
    imageUrl:
  ...
  Inbounds(
    name: 'Julia Altieri',
    bio:
        'Hallo!! My name is Julia Altieri. I\'m from Mercedes, a small town in Buenos Aires, Argentina. I\'m 16 years old and I love reading fantasy books, visiting new places and music. I\'m not a musician but singing out of tune is my passion. 😂\n\nThis year I\'m going to the city Emmen, district 1590, in the east of the Nederlands and close to Germany. And my host club will be Rotary Emmen-\'t Loo.\n\nI\'m so excited about this experience coming true. I hope I can meet new people and learn about everything I\'m able to. This year will probably be my best one and I\'m planning to make the most of it. 😁',
    imageUrl:
  ...
  Inbounds(
    name: 'Luke Rankin',
    bio:
        'Mijn naam is Luke en ik ben veertien jaar. Ik ga in augustus naar Oss, Brabant Noord in de Rotary wijk 1550. Mijn favoriete hobby’s zijn tennis, fietsen, en wandelen.\n\nMy name is Luke and I am 14 years old. In August I go to Oss, Brabant Noord in Rotary club 1550. My favorite hobbies are tennis, biking and hiking.',
    imageUrl:
  ...
  Inbounds(
    name: 'Kailee Deaver',
    bio:
        'Hello!! I’m Kailee deaver and I’m going to be spending the next year in Blauwestad Netherlands! I’m from Wisconsin USA and use she/her pronouns. A little bit about myself is that I have been dancing for 12 years now and have loved all the time spent at the studio. I dance ballet, jazz, tap, modern, and I’m part of my studios competition team! I really enjoy being at the studio with all of my friends, they are just like a second family to me. Another fun hobby I do is aerial arts, I just started classes about 2 months ago but I love being in the air. I know it’s not a common hoodie but I have enjoyed my time with all the lovely people at the garage. I also enjoy cooking and baking. I have taken two years of culinary classes at my school and found out that I really enjoy cooking! Something about trying out new recipes and spending time in the kitchen is very nice and calming for me. Of course with cooking always comes baking and who doesn’t look a good homemade cookie. Baking is fun for me because I have a big sweet tooth and love trying out all the different ways to make sweet treats.',
    imageUrl:
  ...
  Inbounds(
    name: 'Wren L’Heureux',
    bio:
        'Hello my name is wren L’Heureux \n\nI am from the United States. I live in the capital of Florida, Tallahassee. I\'m 16 years old and I just graduated from high school this past year. I spend most of my time either with my family and friends or at work. I work with kids for a program called “Kumon.” This will be my third year at my job, and I love every second of it. It will for sure be something I miss the most while I\'m gone. But the excitement I feel regarding my exchange is hard to put into words. I have been working toward being a rotary youth exchange participant for the last few years and seeing that I will be leaving for the Netherlands in August is insane. I will be going to the town of Meppel which is about two and a half hours away from Amsterdam. I cannot wait to see where I will go and the people I will meet over the next year! ',
    imageUrl:
  ...
  Inbounds(
    name: 'Jamie Ambrose',
    bio:
        'Hello! My name is Jamie Ambrose. I’m from San Luis Obispo, a town on the central coast in California, USA. I’m very passionate about martial arts, art, and theatre. I have been interested in going on exchange for years and am really excited to have gotten the opportunity. I’m going to Zierikzee, on the former island of Schouwen-Duiveland (District 1610). I am also excited for the adventure and people I am going to meet there. :)',
    imageUrl:
  ...
  Inbounds(
    name: 'Lilli',
    bio:
        'Hallo allemaal! Mijn naam is Lilli en ik kom uit Finland and I’m going to Weert, south east of the Netherlands (district 1550). Ik ben 17 jaar en ik heb een hond. I think that’s good for now on, my Dutch is even at an almost understandable level :D. I live in the northern Finland, in a city called Oulu with my mother and father. I also have a dog, a schapendoes called Pilvi. I’m a big music “fan” and I’m in a music high school. I play piano, percussions and I love to sing. Theatre is also important to me. I love to express my feelings through it and just throw myself into situations as stupid as possible. Also spending time with my friends and family, cooking and baking, going to gym, playing board and card games and watching series are close to my heart. I’ve been dreaming about learning languages, travelling around the world and discovering different cultures since I can even remember. ',
    imageUrl:
  ...
  Inbounds(
    ...
    bio:
        'Hi I’m Cristina Iacobelli and I will spend a year in the Netherlands (district 1580). I was born and I live in Rome in Italy (district 2080). I am sociable, selfless and solar. I really like to travel. ',
    imageUrl:
  ...
  Inbounds(
    name: 'Marika Sansone',
    bio:
        '“Hi my name is Marika Sansone. On August 20th I will leave for my year abroad in Netherlands, precisely in Enschede, thanks to the Hengelo-Enschede rotary district. I will spend 10 months in this beautiful country, learning a new culture and a new language.\n\nI really like art and I think the Netherlands is very artistic. I love traveling and having new experiences, so I am very happy to embark on this adventure.”',
    imageUrl:
