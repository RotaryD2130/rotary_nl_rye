...
import 'package:rotary2130_2140_rye/core/domain/repository/stories_repository.dart';
...
class StoriesRepositoryImpl implements StoriesRepository {
  ...
  Future<List<Story>> getCachedStories(
      String studentExchangeYear, String studentName) async {
    final List temp =
        json.decode(await cache.getByKey(studentExchangeYear + studentName));
  ...
  Future<String> getStoriesData(
    ...
    final String url =
        "https://www.rotary.nl/yep/yep-app/tu4w6b3-6436ie5-63h0jf-9i639i4-t3mf67-uhdrs/rebounds/students/$studentExchangeYear/${studentName.replaceAll(" ", "_").toLowerCase()}.json";
